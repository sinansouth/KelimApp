...
export const AVATARS: Avatar[] = [
  ...
  // Level 1-10
  { id: 'student', icon: '🧑‍🎓', image: '/assets/avatars/student.png', name: 'Öğrenci', unlockLevel: 1, bgGradient: 'from-blue-400 to-indigo-500', border: 'border-blue-200' },
  { id: 'cat', icon: '🐱', image: '/assets/avatars/cat.png', name: 'Kedi', unlockLevel: 2, bgGradient: 'from-orange-300 to-amber-400', border: 'border-orange-200' },
  { id: 'dog', icon: '🐶', image: '/assets/avatars/dog.png', name: 'Köpek', unlockLevel: 3, bgGradient: 'from-stone-300 to-stone-500', border: 'border-stone-300' },
  { id: 'fox', icon: '🦊', image: '/assets/avatars/fox.png', name: 'Tilki', unlockLevel: 4, bgGradient: 'from-orange-500 to-red-600', border: 'border-orange-300' },
  { id: 'panda', icon: '🐼', image: '/assets/avatars/panda.png', name: 'Panda', unlockLevel: 5, bgGradient: 'from-slate-800 to-black', border: 'border-slate-400' },
  { id: 'koala', icon: '🐨', image: '/assets/avatars/koala.png', name: 'Koala', unlockLevel: 6, bgGradient: 'from-gray-300 to-gray-500', border: 'border-gray-300' },
  { id: 'rabbit', icon: '🐰', image: '/assets/avatars/rabbit.png', name: 'Tavşan', unlockLevel: 7, bgGradient: 'from-pink-200 to-pink-400', border: 'border-pink-200' },
  { id: 'lion', icon: '🦁', image: '/assets/avatars/lion.png', name: 'Aslan', unlockLevel: 8, bgGradient: 'from-yellow-400 to-orange-500', border: 'border-yellow-300' },
  { id: 'tiger', icon: '🐯', image: '/assets/avatars/tiger.png', name: 'Kaplan', unlockLevel: 9, bgGradient: 'from-orange-400 to-red-500', border: 'border-orange-300' },
  { id: 'wolf', icon: '🐺', image: '/assets/avatars/wolf.png', name: 'Kurt', unlockLevel: 10, bgGradient: 'from-slate-400 to-slate-600', border: 'border-slate-400' },

  { id: 'bear', icon: '🐻', image: '/assets/avatars/bear.png', name: 'Ayı', unlockLevel: 11, bgGradient: 'from-amber-700 to-amber-900', border: 'border-amber-600' },
  { id: 'detective', icon: '🕵️', image: '/assets/avatars/detective.png', name: 'Dedektif', unlockLevel: 12, bgGradient: 'from-neutral-600 to-neutral-800', border: 'border-neutral-400' },
  { id: 'chicken', icon: '🐔', image: '/assets/avatars/chicken.png', name: 'Tavuk', unlockLevel: 13, bgGradient: 'from-red-100 to-red-300', border: 'border-red-200' },
  { id: 'frog', icon: '🐸', image: '/assets/avatars/frog.png', name: 'Kurbağa', unlockLevel: 14, bgGradient: 'from-green-500 to-green-700', border: 'border-green-400' },
  { id: 'scientist', icon: '👩‍🔬', image: '/assets/avatars/scientist.png', name: 'Bilim İnsanı', unlockLevel: 15, bgGradient: 'from-green-400 to-teal-500', border: 'border-green-200' },
  { id: 'pig', icon: '🐷', image: '/assets/avatars/pig.png', name: 'Domuzcuk', unlockLevel: 16, bgGradient: 'from-pink-300 to-rose-400', border: 'border-pink-300' },
  { id: 'cow', icon: '🐮', image: '/assets/avatars/cow.png', name: 'İnek', unlockLevel: 17, bgGradient: 'from-stone-200 to-stone-400', border: 'border-stone-300' },
  { id: 'artist', icon: '🎨', image: '/assets/avatars/artist.png', name: 'Sanatçı', unlockLevel: 18, bgGradient: 'from-pink-400 to-rose-500', border: 'border-pink-200' },
  { id: 'mouse', icon: '🐭', image: '/assets/avatars/mouse.png', name: 'Fare', unlockLevel: 19, bgGradient: 'from-gray-400 to-gray-600', border: 'border-gray-300' },
  { id: 'astronaut', icon: '👨‍🚀', image: '/assets/avatars/astronaut.png', name: 'Astronot', unlockLevel: 20, bgGradient: 'from-blue-600 to-blue-900', border: 'border-blue-300' },

  { id: 'hamster', icon: '🐹', image: '/assets/avatars/hamster.png', name: 'Hamster', unlockLevel: 21, bgGradient: 'from-orange-200 to-orange-400', border: 'border-orange-200' },
  { id: 'pilot', icon: '👨‍✈️', image: '/assets/avatars/pilot.png', name: 'Pilot', unlockLevel: 22, bgGradient: 'from-sky-400 to-sky-600', border: 'border-sky-200' },
  { id: 'chef', icon: '👨‍🍳', image: '/assets/avatars/chef.png', name: 'Şef', unlockLevel: 23, bgGradient: 'from-white to-gray-200', border: 'border-gray-300' },
  { id: 'fireman', icon: '👨‍🚒', image: '/assets/avatars/fireman.png', name: 'İtfaiyeci', unlockLevel: 24, bgGradient: 'from-red-500 to-orange-500', border: 'border-yellow-400' },
  { id: 'doctor', icon: '👨‍⚕️', image: '/assets/avatars/doctor.png', name: 'Doktor', unlockLevel: 25, bgGradient: 'from-emerald-400 to-emerald-600', border: 'border-emerald-200' },
  { id: 'judge', icon: '👨‍⚖️', image: '/assets/avatars/judge.png', name: 'Hakim', unlockLevel: 26, bgGradient: 'from-slate-700 to-black', border: 'border-slate-500' },
  { id: 'mechanic', icon: '👨‍🔧', image: '/assets/avatars/mechanic.png', name: 'Tamirci', unlockLevel: 27, bgGradient: 'from-blue-700 to-blue-900', border: 'border-blue-500' },
  { id: 'cowboy', icon: '🤠', image: '/assets/avatars/cowboy.png', name: 'Kovboy', unlockLevel: 28, bgGradient: 'from-orange-300 to-amber-600', border: 'border-amber-700' },
  { id: 'clown', icon: '🤡', image: '/assets/avatars/clown.png', name: 'Palyaço', unlockLevel: 29, bgGradient: 'from-red-400 to-yellow-400', border: 'border-blue-400' },
  { id: 'party_face', icon: '🥳', image: '/assets/avatars/party_face.png', name: 'Partici', unlockLevel: 30, bgGradient: 'from-purple-400 to-pink-400', border: 'border-purple-300' },

  { id: 'superhero', icon: '🦸', image: '/assets/avatars/superhero.png', name: 'Kahraman', unlockLevel: 35, bgGradient: 'from-blue-500 to-red-500', border: 'border-yellow-400' },
  { id: 'villain', icon: '🦹', image: '/assets/avatars/villain.png', name: 'Kötü Adam', unlockLevel: 38, bgGradient: 'from-green-700 to-purple-800', border: 'border-green-500' },
  { id: 'wizard', icon: '🧙‍♂️', image: '/assets/avatars/wizard.png', name: 'Büyücü', unlockLevel: 40, bgGradient: 'from-purple-600 to-indigo-800', border: 'border-purple-400' },
  { id: 'fairy', icon: '🧚', image: '/assets/avatars/fairy.png', name: 'Peri', unlockLevel: 41, bgGradient: 'from-pink-300 to-green-300', border: 'border-white' },
  { id: 'pirate', icon: '🏴‍☠️', image: '/assets/avatars/pirate.png', name: 'Korsan', unlockLevel: 42, bgGradient: 'from-red-800 to-black', border: 'border-gray-400' },
  { id: 'robot', icon: '🤖', image: '/assets/avatars/robot.png', name: 'Robot', unlockLevel: 45, bgGradient: 'from-gray-300 to-slate-500', border: 'border-gray-200' },
  { id: 'alien', icon: '👽', image: '/assets/avatars/alien.png', name: 'Uzaylı', unlockLevel: 50, bgGradient: 'from-green-400 to-emerald-600', border: 'border-green-200' },
  { id: 'ninja_master', icon: '🥷', image: '/assets/avatars/ninja_master.png', name: 'Ninja Ustası', unlockLevel: 55, bgGradient: 'from-gray-800 to-black', border: 'border-red-600' },
  { id: 'queen', icon: '👸', image: '/assets/avatars/queen.png', name: 'Kraliçe', unlockLevel: 60, bgGradient: 'from-pink-400 to-rose-500', border: 'border-pink-300' },
  { id: 'king', icon: '🤴', image: '/assets/avatars/king.png', name: 'Kral', unlockLevel: 65, bgGradient: 'from-yellow-500 to-red-600', border: 'border-yellow-500' },

  { id: 'dragon', icon: '🐉', image: '/assets/avatars/dragon.png', name: 'Ejderha', unlockLevel: 70, bgGradient: 'from-red-600 to-orange-600', border: 'border-yellow-500' },
  { id: 'dino', icon: '🦖', image: '/assets/avatars/dino.png', name: 'T-Rex', unlockLevel: 75, bgGradient: 'from-green-700 to-stone-700', border: 'border-green-600' },
  { id: 'unicorn', icon: '🦄', image: '/assets/avatars/unicorn.png', name: 'Tekboynuz', unlockLevel: 80, bgGradient: 'from-pink-200 to-indigo-200', border: 'border-white' },
  { id: 'octopus', icon: '🐙', image: '/assets/avatars/octopus.png', name: 'Ahtapot', unlockLevel: 85, bgGradient: 'from-purple-500 to-pink-500', border: 'border-purple-400' },
  { id: 'phoenix', icon: '🦅', image: '/assets/avatars/phoenix.png', name: 'Anka Kuşu', unlockLevel: 90, bgGradient: 'from-orange-500 to-red-600', border: 'border-orange-400' },
  { id: 'ghost', icon: '👻', image: '/assets/avatars/ghost.png', name: 'Hayalet', unlockLevel: 95, bgGradient: 'from-gray-200 to-white', border: 'border-gray-300' },
  { id: 'diamond', icon: '💎', image: '/assets/avatars/diamond.png', name: 'Efsane', unlockLevel: 100, bgGradient: 'from-cyan-200 to-blue-400', border: 'border-white' },
  { id: 'vampire', icon: '🧛', image: '/assets/avatars/vampire.png', name: 'Vampir', unlockLevel: 110, bgGradient: 'from-red-900 to-slate-900', border: 'border-red-600' },
  { id: 'cyborg', icon: '🦾', image: '/assets/avatars/cyborg.png', name: 'Sayborg', unlockLevel: 120, bgGradient: 'from-slate-700 to-cyan-500', border: 'border-cyan-400' },
  { id: 'zombie', icon: '🧟', image: '/assets/avatars/zombie.png', name: 'Zombi', unlockLevel: 130, bgGradient: 'from-green-800 to-stone-700', border: 'border-green-700' },

  { id: 'genie', icon: '🧞', image: '/assets/avatars/genie.png', name: 'Cin', unlockLevel: 140, bgGradient: 'from-cyan-500 to-blue-600', border: 'border-cyan-300' },
  { id: 'angel', icon: '👼', image: '/assets/avatars/angel.png', name: 'Melek', unlockLevel: 150, bgGradient: 'from-sky-200 to-white', border: 'border-sky-200' },
  { id: 'elf', icon: '🧝', image: '/assets/avatars/elf.png', name: 'Elf', unlockLevel: 160, bgGradient: 'from-green-300 to-emerald-500', border: 'border-emerald-300' },
  { id: 'mermaid', icon: '🧜‍♀️', image: '/assets/avatars/mermaid.png', name: 'Deniz Kızı', unlockLevel: 180, bgGradient: 'from-blue-400 to-green-400', border: 'border-cyan-300' },
  { id: 'demon', icon: '👿', image: '/assets/avatars/demon.png', name: 'İblis', unlockLevel: 200, bgGradient: 'from-red-900 to-black', border: 'border-red-800' },
  { id: 'zeus', icon: '⚡', image: '/assets/avatars/zeus.png', name: 'Zeus', unlockLevel: 250, bgGradient: 'from-yellow-300 to-blue-500', border: 'border-yellow-400' },
  { id: 'master', icon: '🧘', image: '/assets/avatars/master.png', name: 'Usta', unlockLevel: 300, bgGradient: 'from-indigo-500 to-purple-600', border: 'border-white' },
  { id: 'rockstar', icon: '🎸', image: '/assets/avatars/rockstar.png', name: 'Rock Yıldızı', unlockLevel: 350, bgGradient: 'from-pink-600 to-purple-800', border: 'border-pink-500' },
  { id: 'gamer', icon: '🎮', image: '/assets/avatars/gamer.png', name: 'Oyuncu', unlockLevel: 400, bgGradient: 'from-green-400 to-black', border: 'border-green-500' },
  { id: 'brain', icon: '🧠', image: '/assets/avatars/brain.png', name: 'Dahi', unlockLevel: 500, bgGradient: 'from-pink-300 to-rose-400', border: 'border-white' },
];
