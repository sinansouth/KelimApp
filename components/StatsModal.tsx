                    ...
                    {activeTab === 'general' && (
                        <div className="space-y-6">
                            ...
                            <div className="p-5 rounded-3xl border" style={{ backgroundColor: 'rgba(var(--color-bg-card-rgb), 0.5)', borderColor: 'var(--color-border)' }}>
                                ...
                                <div className="flex items-end justify-between gap-2 h-32 pt-4">
                                    {[1, 2, 3, 4, 5].map(box => {
                                        ...
                                        return (
                                            <div key={box} className="flex-1 flex flex-col items-center justify-end gap-2 group relative">
                                                {/* Tooltip on hover */}
                                                <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-slate-800 text-white text-[10px] px-2 py-0.5 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap z-20">
                                                    {count} Kelime
                                                </div>

                                                <div className="font-bold text-[10px] sm:text-xs transition-all group-hover:-translate-y-1" style={{ color: 'var(--color-text-main)' }}>{count}</div>
                                                ...
                                                <div
                                                    ...
                                                    style={{
                                                        ...
                                                        boxShadow: box === 5
                                                            ...
                                                            : '0 4px 6px -1px rgba(129, 140, 248, 0.3)'
                                                    }}
                                                >
                                                    {/* Subtle inner reflection */}
                                                    <div className="w-full h-full bg-white/10 rounded-t-2xl"></div>
                                                </div>

                                                <div className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">KUTU {box}</div>
                                            </div>
                                        )
                                    })}
                                </div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="p-3 rounded-2xl border flex flex-col items-center justify-center text-center gap-1" style={{ backgroundColor: 'var(--color-bg-main)', borderColor: 'var(--color-border)' }}>
                                    <span className="text-[10px] uppercase font-bold" style={{ color: 'var(--color-text-muted)' }}>Ezberlenen</span>
                                    <span className="text-lg font-black text-green-500">{memorizedCount}</span>
                                </div>
                                <div className="p-3 rounded-2xl border flex flex-col items-center justify-center text-center gap-1" style={{ backgroundColor: 'var(--color-bg-main)', borderColor: 'var(--color-border)' }}>
                                    <span className="text-[10px] uppercase font-bold" style={{ color: 'var(--color-text-muted)' }}>Favoriler</span>
