                                ...
                                <div className="bg-slate-800 p-6 md:p-8 rounded-3xl border border-slate-700 shadow-xl">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                <label className="text-xs font-bold text-slate-400 block mb-1">Zorluk</label>
                                                <select value={tDifficulty} onChange={(e) => setTDifficulty(e.target.value as any)} className="w-full p-2 bg-slate-900 border border-slate-600 rounded-xl text-xs">
                                                    <option value="relaxed">Rahat (30s)</option>
                                                    <option value="easy">Kolay (20s)</option>
                                                    <option value="normal">Normal (15s)</option>
                                                    <option value="hard">Zor (10s)</option>
                                                    <option value="impossible">İmkansız (5s)</option>
                                                </select>
                                            </div>
                                        </div>
